        ...
        <Grid container spacing={2} className="mis-datos-info m-5">
          ...
          <Grid item xs={12} md={6}>
            <Grid container direction="column" spacing={1}>
              ...
              <Grid item>
                <Typography>
                  <strong>Empresa:</strong> {user.empresa?.nombre || user.empresa?._id || '-'}
                </Typography>
              </Grid>
              <Grid item><Typography><strong>Creado el:</strong> {new Date(user.created_at).toLocaleString()}</Typography></Grid>
