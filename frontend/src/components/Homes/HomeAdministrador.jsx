...
// Hooks y Contexto (Tal cual lo usas en HomeAdministrador)
...
const StaffFormModal = ({ open, onClose, onSave, staffToEdit }) => {
  ...
  const { user } = useAuth(); // Acceso al payload del token
  ...
  const handleSubmit = async (e) => {
    ...
    // Concatenamos nombre y apellido del admin logueado desde el context
    const adminFullName = user 
